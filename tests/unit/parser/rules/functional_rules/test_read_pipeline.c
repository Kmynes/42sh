...
void test_read_pipeline_multiple(void)
{
    ...
    struct ast_node *ast = ast_from_read(read_pipeline, input);
    print_state_test(ast->children[0]->type == AST_COMMAND, "test_read_pipeline_multiple (2)");
    ...
    print_state_test(ast->children[0]->type == AST_COMMAND, "test_read_pipeline_multiple (5)");
    ...
    print_state_test(ast->children[0]->type == AST_COMMAND, "test_read_pipeline_multiple (8)");

    print_state_test(ast->children[1]->type == AST_COMMAND, "test_read_pipeline_multiple (9)");

    print_state_test(ast->children[2]->type == AST_COMMAND, "test_read_pipeline_multiple (10)");
    ast_free(ast);
}
