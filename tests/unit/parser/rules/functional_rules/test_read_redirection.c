...
void test_read_redirection_1(void)
{
...
void test_read_redirection_2(void)
{
    bool check = test_rule(read_redirection, "2>&test.sh",
                      "AST_REDIRECTION(0)_2_>&_test.sh");
...
{
    test_read_redirection_1();
    test_read_redirection_2();
}